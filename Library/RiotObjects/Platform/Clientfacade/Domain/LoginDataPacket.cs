...
using System.Linq;
using System.Text;
using PVPNetCorrect.RiotObjects.Platform.Statistics;
using PVPNetCorrect.RiotObjects.Platform.Summoner;
using PVPNetCorrect.RiotObjects.Platform.Broadcast;
using PVPNetCorrect.RiotObjects.Platform.Systemstate;
using PVPNetCorrect.RiotObjects.Kudos.Dto;
using PVPNetCorrect.RiotObjects.Platform.Game;

namespace PVPNetCorrect.RiotObjects.Platform.Clientfacade.Domain
{
