...
namespace PVPNetCorrect.RiotObjects
{
	/// <summary>
				...
				try
				{
					...
					else if (type.IsGenericType && type.GetGenericTypeDefinition() == typeof(List<>))
					{
						...
						foreach (object data in temp)
						{
							...
							else if (elementType == typeof(PVPNetCorrect.RiotObjects.Platform.Game.Participant))
							{
								TypedObject dataAsTo = (TypedObject)data;
								if (dataAsTo.type == "com.riotgames.platform.game.BotParticipant")
									objectList.Add(new PVPNetCorrect.RiotObjects.Platform.Game.BotParticipant(dataAsTo));
								else if (dataAsTo.type == "com.riotgames.platform.game.ObfruscatedParticipant")
									objectList.Add(new PVPNetCorrect.RiotObjects.Platform.Game.ObfruscatedParticipant(dataAsTo));
								else if (dataAsTo.type == "com.riotgames.platform.game.PlayerParticipant")
									objectList.Add(new PVPNetCorrect.RiotObjects.Platform.Game.PlayerParticipant(dataAsTo));
								else if (dataAsTo.type == "com.riotgames.platform.reroll.pojo.AramPlayerParticipant")
									objectList.Add(new PVPNetCorrect.RiotObjects.Platform.Reroll.Pojo.AramPlayerParticipant(dataAsTo));
							}
							else
							{
